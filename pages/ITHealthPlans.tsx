...
import { ITPlanCard } from '../components/marketplace/ITPlanCard';
...
// Define the plan data according to the specifications
const PLANS = {
  operate: [
    {
      id: "user-health-plan",
...
export function ITHealthPlans() {
  ...
  const handlePlanClick = (planId: string) => {
    ...
    // Navigate to the corresponding plan page
    window.location.href = `/plans/${planId}`;
  };
  
  // Handle comparison
  const handleCompareClick = () => {
    toast.info("Plan comparison feature coming soon!");
  };
  ...
  return (
    <div className="space-y-8 public-container">
      {/* Hero */}
      <div className="bg-hero-bg text-white p-8 rounded-[16px] rounded-tr-[0px] mb-6">
        <div className="max-w-2xl">
          <h2 className="text-2xl font-extralight mb-2">Healthy IT. Happy Business.</h2>
          <p className="text-white/80 text-xs mb-6">
            Browse our comprehensive IT plans designed to help South African professional firms
            operate, secure, streamline, and accelerate your technology infrastructure.
          </p>
          <Button className="bg-white text-blue hover:bg-white/90 rounded-[16px] rounded-tr-[0px]">
            Book Consultation
          </Button>
        </div>
      </div>
        ...
        <TabsContent value="all" className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-extralight text-navy">Operate Phase</h2>
                <p className="text-xs text-muted-foreground">Foundation services that keep your business running smoothly</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-extralight text-navy">Secure Phase</h2>
                <p className="text-xs text-muted-foreground">Protect your business, people, and data from risk</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-extralight text-navy">Streamline Phase</h2>
                <p className="text-xs text-muted-foreground">Drive efficiency, reduce waste, and automate routine work</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-extralight text-navy">Accelerate Phase</h2>
                <p className="text-xs text-muted-foreground">Unlock digital transformation, insights, and innovation</p>
              </div>
            </div>
